  ...
  return (
    <div style={{ backgroundColor: "#000", padding: "25px 0" }}>
      <Flex justify="end" align="center">
        <nav className="navbar navbar-expand navbar-dark bg-transparent me-5">
          <div className="container-fluid">
            <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
              <div className="navbar-nav">
                <a className={`nav-link me-5 ${pathname === "/" && "active"}`} aria-current="page" href="/">
                  Home
                </a>
                <a className={`nav-link me-5 ${pathname === "/shop" && "active"}`} href="/shop">
                  Shop
                </a>
                <a className={`nav-link ${pathname === "/about" && "active"}`} href="/about">
                  About
                </a>
              </div>
            </div>
        ...
        <Box>
          ...
          >
            <Drawer.Trigger asChild>
              <button
                type="button"
                className="btn btn-lg bg-transparent text-light position-relative me-5"
              >
                <RiMenuFill size={25} />
                  ...
                  <Drawer.Header>
                    <Flex justify="space-between" align="center" width="100%">
                      ...
                      <button
                        ...
                        type="button"
                        className="btn btn-md bg-transparent text-light"
