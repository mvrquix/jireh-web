      ...
      >
        <div className="page-height">
          <div className="full-size-banner-entry full-size valign-middle">
            <div className="valign-text-wrapper">
              <div className="row">
                <div className="container">
                  <div className="row">
                    <div className="col-sm-6 col-xs-text-center col-sm-text-left">
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="scroll-button style-3 light hidden-xs"></div>
        </div>
      </div>

      <div className="container">
            <div className="empty-space col-xs-b55 col-sm-b110"></div>
